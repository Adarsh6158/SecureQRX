          ...
          // Sender and recipient
            ...
            <div style='font-family: Arial, sans-serif; background-color: #f8f8f8; padding: 20px;'>
                <div style='background-color: #ffffff; padding: 20px; border-radius: 5px;'>
                    <h2 style='color: #003366;'>Password</h2>
                    <p style='color: #333333; font-size: 16px;'>Dear $name,</p>
                    <p style='color: #333333; font-size: 16px;'>Your Email is:$email</p>
                    <p style='color: #333333; font-size: 16px;'>Your password is:$plainPassword</p>
                    <p style='color: #333333; font-size: 16px;'>We hope you will enjoy using SecureQRX.</p>
                    <p style='color: #333333; font-size: 16px;'><br>Best regards,</p>
                    <p style='color: #333333; font-size: 16px;'>Adarsh</p>
